...
void getTorque(float* state, quat_t quat_d, vector_3t omega_d, vector_3t tau_ff, quat_t quat_a, vector_3t &torque) {
  ...
  delta_omega = omega_a - omega_d;
    Serial.print(delta_omega[0]); Serial.print(", ");
      Serial.print(delta_omega[1]); Serial.print(", ");
      Serial.print(delta_omega[2]); Serial.print(",     ");
  ...
  Serial.print(tau_fb[0]); Serial.print(", ");
      ...
      Serial.print(tau_fb[2]); Serial.print(",     ");
        ...
        Serial.print(tau_ff[0]); Serial.print(", ");
      Serial.print(tau_ff[1]); Serial.print(", ");
      Serial.print(tau_ff[2]); Serial.print(",     ");
}
